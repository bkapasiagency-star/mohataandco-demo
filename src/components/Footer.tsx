import { Facebook, Twitter, Linkedin, ArrowUp, Phone, Mail } from 'lucide-react';
          ...
          <div className="lg:col-span-4 lg:col-start-1 space-y-6">
            <div className="flex items-center space-x-3">
              <img
                ...
                className="h-11 md:h-12 w-auto hover:scale-105 transition-transform duration-300"
              />
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              >
                <WhatsAppIcon size={14} className="text-[#1FA54A]" />
