                    ...
                    <div className="relative z-10">
                      ...
                      >
                        <div className="flex items-start space-x-6 md:space-x-10">
                          {/* Big Number */}
                          <span className="font-mono text-xl md:text-2xl text-gray-300 font-semibold group-hover:text-[#0057B8] transition-colors">
                            {service.number}
                          </span>
                          ...
                          <div className="space-y-2">
                            ...
                            {!isOpen && (
                              <p className="text-sm text-gray-500 max-w-xl font-normal leading-relaxed truncate md:whitespace-normal md:line-clamp-2">
                                {service.shortDesc}
                              </p>
                            )}
                          </div>
                        ...
                        {/* Icon Toggle */}
                        <div className={`p-2 rounded-full border border-gray-200 text-gray-400 group-hover:text-[#0057B8] group-hover:border-[#0057B8] transition-all ${isOpen ? 'bg-[#0057B8] text-white border-[#0057B8] rotate-180' : ''}`}>
                          <ChevronDown size={18} />
                        </div>
                      </button>
