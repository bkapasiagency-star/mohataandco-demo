      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center space-x-3 group">
            <BrandLogo size={38} className="group-hover:scale-105" />
            ...
            <div className="hidden sm:block w-px h-8 bg-[#DCE6F2] mx-1" />
            <img
              src={caIndiaLogo}
              alt="CA India — ICAI Member Firm"
              className="hidden sm:block h-7 w-auto opacity-90 group-hover:opacity-100 transition-opacity duration-300"
            />
          </a>
